class scene2 extends Phaser.Scene {
	...
	resetShipPos(ship){
		ship.y = 0;
		var randomX = Phaser.Math.Between(200, this.game.config.width-200);
		ship.x = randomX;
	...
	shootBeam(){
			...
			var x1 = Math.round(this.p_ship.x - 50);
			var y1 = Math.round(this.p_ship.y - 20);
			var x2 = Math.round(this.p_ship.x + 34);
			var y2 = Math.round(this.p_ship.y - 20);

			var beam = new Beam(this, x1, y1);
			var beam = new Beam(this,x2, y2 );
			this.beamSound.play();
	...
	create() {
		...
		this.b_ship.setScale(.8);

		this.p_ship.setScale(.3);
		



		this.e_ship = this.add.image(100, 0, "enemyship");
		this.e_ship2 = this.add.image(300, 0, "enemyship");
		this.e_ship3 = this.add.image(1500, 0, "enemyship");
		this.e_ship4 = this.add.image(1100, 0, "enemyship");
		this.e_ship5 = this.add.image(1300, 0, "enemyship");

		this.e_ship.setScale(.1);
		this.e_ship2.setScale(.1);
		this.e_ship3.setScale(.1);
		this.e_ship4.setScale(.1);
		this.e_ship5.setScale(.1);
	...
	update(){
		this.moveShip(this.e_ship,2.2);
		this.moveShip(this.e_ship2,2.6);
		this.moveShip(this.e_ship3,2.6);
		this.moveShip(this.e_ship4,2);
		this.moveShip(this.e_ship5,2.8);


		//this.handleOrientation();
		this.movePlayerManager();
		this.spaceBarManager();
