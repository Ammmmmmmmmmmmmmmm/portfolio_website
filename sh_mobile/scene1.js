class scene1 extends Phaser.Scene {
	...
	preload(){
		...
		this.load.image("background", "../assets/images/backgroundmobile.png");
		this.load.image("titlescreen", "../assets/images/titlemobile2.png");
		...
		this.load.image("finger", "../assets/images/pixelated_hand.png")
	...
	create() {
		...
		this.scoreLabel1 = this.add.bitmapText(60, 130, "pixelFont", "HIGH SCORE  000000", 30);
		...
		this.plane = this.add.image(-100, 180, "plane");
	    ...
	    /*
	    this.chase = this.add.image(-300, 180, "chaser");
		this.chase.setScale(.13);
	    this.tweens.add({
	        targets: this.chase,
		...
		*/
	    ...
	    this.fakeplayer = this.add.image(160, 370, "playership");
		this.finger = this.add.image(195, 385, "finger");
		this.finger.setScale(.08);
		this.fakeplayer.setScale(.1);
		...
		this.playButton = this.add.image(155,250, "play");
